                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <div class="form-line">
                                        {!! Form::select('add_khoa', \App\Models\Khoa::pluck('tenkhoa', 'makhoa')->all(), null, ['id'=>'add_khoa', 'class'=>'change-search-select2 form-control input-sm','style'=>'width:100%']) !!}
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="form-line">
                                        {!! Form::select('add_lop', \App\Models\Lop::pluck('tenlop', 'id')->all(), null, ['id'=>'add_lop', 'class'=>'change-search-select2 form-control input-sm','style'=>'width:100%']) !!}
                                        {{--<select class="selectpicker show-tick form-control" name="level" id="level" style="width: 100%;" required>--}}
                                        {{--<option></option>--}}
                                        {{--<option value="0">Admin</option>--}}
                                        {{--<option value="1">Thành Viên</option>--}}
